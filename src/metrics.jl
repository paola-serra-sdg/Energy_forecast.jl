...
Plots.histogram(MAE_test_PM,legend=false, alpha = 0.4, color=:green)
Plots.histogram!(MAE_test_CNN,legend=false, alpha = 0.4, color=:orchid)
Plots.histogram!(MAE_test_CNN_2, legend=false, alpha = 0.4, color=:blue)
